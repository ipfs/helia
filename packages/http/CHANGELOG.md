...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/fallback-router bumped from ^1.1.0 to ^1.1.1
    * @helia/interface bumped from ^7.1.0 to ^7.1.1
    * @helia/trustless-gateway-client bumped from ^1.0.4 to ^1.0.5
...
## [3.1.2](https://github.com/ipfs/helia/compare/http-v3.1.1...http-v3.1.2) (2026-04-10)
...
## [3.0.22](https://github.com/ipfs/helia/compare/http-v3.0.21...http-v3.0.22) (2026-03-18)
