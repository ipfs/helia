# @helia/rpc-protocol <!-- omit in toc -->
...
Loading this module through a script tag will make it's exports available as `HeliaRpcProtocol` in the global namespace.

```html
<script src="https://unpkg.com/@helia/rpc-protocol/dist/index.min.js"></script>
```

## API Docs

- <https://ipfs.github.io/helia/modules/_helia_rpc_protocol.html>
