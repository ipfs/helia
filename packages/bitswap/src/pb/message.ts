...
export namespace WantlistEntry {
  ...
  export const decode = (
    ...
    opts?: DecodeOptions<WantlistEntry>,
  ): WantlistEntry => {
        ...
        (reader, length, opts = {}) => {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              case 1: {
                if (
                  opts.limits?.entries != null &&
                  obj.entries.length === opts.limits.entries
                ) {
                  throw new CodeError(
                    'decode error - map field "entries" had too many elements',
                    "ERR_MAX_LENGTH",
                  );
                }

                obj.entries.push(
                  WantlistEntry.codec().decode(reader, reader.uint32(), {
...
export namespace BlockPresence {
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<BlockPresence>,
  ): BlockPresence => {
...
export namespace BitswapMessage {
      ...
      _codec = message<BitswapMessage>(
        ...
        (reader, length, opts = {}) => {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              case 1: {
                obj.wantlist = Wantlist.codec().decode(
                  reader,
                  reader.uint32(),
                  {
              ...
              case 3: {
                if (
                  opts.limits?.blocks != null &&
                  obj.blocks.length === opts.limits.blocks
                ) {
                  throw new CodeError(
                    'decode error - map field "blocks" had too many elements',
                    "ERR_MAX_LENGTH",
                  );
                }

                obj.blocks.push(
                  Block.codec().decode(reader, reader.uint32(), {
              ...
              case 4: {
                if (
                  opts.limits?.blockPresences != null &&
                  obj.blockPresences.length === opts.limits.blockPresences
                ) {
                  throw new CodeError(
                    'decode error - map field "blockPresences" had too many elements',
                    "ERR_MAX_LENGTH",
                  );
                }

                obj.blockPresences.push(
                  BlockPresence.codec().decode(reader, reader.uint32(), {
  ...
  export const decode = (
    buf: Uint8Array | Uint8ArrayList,
    opts?: DecodeOptions<BitswapMessage>,
  ): BitswapMessage => {
