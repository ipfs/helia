...
export async function createHeliaNode(): Promise<
  HeliaLibp2p<Libp2p<DefaultLibp2pServices>>
>;
export async function createHeliaNode<Services extends Record<string, unknown>>(
  libp2pOptions: Libp2pOptions<Services>,
): Promise<HeliaLibp2p<Libp2p<Services & DefaultLibp2pServices>>>;
