...
* The following workspace dependencies were updated
  * dependencies
    * @helia/bitswap bumped from ^4.0.18 to ^4.0.19
    * @helia/ipns bumped from ^10.2.0 to ^10.2.1
    * helia bumped from ^7.1.14 to ^7.1.15
...
* The following workspace dependencies were updated
  * dependencies
    * @helia/bitswap bumped from ^4.0.16 to ^4.0.17
    * helia bumped from ^7.1.12 to ^7.1.13
...
* The following workspace dependencies were updated
  * dependencies
    * @helia/bitswap bumped from ^4.0.13 to ^4.0.14
    * @helia/libp2p bumped from ^2.1.2 to ^2.1.3
    * helia bumped from ^7.1.9 to ^7.1.10

## [12.1.3](https://github.com/ipfs/helia/compare/interop-v12.1.2...interop-v12.1.3) (2026-08-21)
...
* The following workspace dependencies were updated
  * dependencies
    * @helia/bitswap bumped from ^4.0.12 to ^4.0.13
    * @helia/libp2p bumped from ^2.1.1 to ^2.1.2
    * helia bumped from ^7.1.8 to ^7.1.9

## [12.1.2](https://github.com/ipfs/helia/compare/interop-v12.1.1...interop-v12.1.2) (2026-08-21)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * helia bumped from ^7.1.7 to ^7.1.8
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/ipns bumped from ^10.0.6 to ^10.0.7
    * @helia/libp2p bumped from ^1.0.7 to ^1.0.8
    * helia bumped from ^7.1.2 to ^7.1.3

## [11.0.10](https://github.com/ipfs/helia/compare/interop-v11.0.9...interop-v11.0.10) (2026-07-28)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/car bumped from ^6.0.4 to ^6.0.5
    * @helia/dag-cbor bumped from ^6.0.4 to ^6.0.5
    * @helia/dag-json bumped from ^6.0.4 to ^6.0.5
    * @helia/delegated-routing-client bumped from ^1.0.5 to ^1.0.6
    * @helia/interface bumped from ^7.1.0 to ^7.1.1
    * @helia/ipns bumped from ^10.0.5 to ^10.0.6
    * @helia/json bumped from ^6.0.4 to ^6.0.5
    * @helia/libp2p bumped from ^1.0.6 to ^1.0.7
    * @helia/mfs bumped from ^8.0.4 to ^8.0.5
    * @helia/strings bumped from ^6.0.4 to ^6.0.5
    * @helia/unixfs bumped from ^8.0.4 to ^8.0.5
    * helia bumped from ^7.1.1 to ^7.1.2

## [11.0.9](https://github.com/ipfs/helia/compare/interop-v11.0.8...interop-v11.0.9) (2026-07-24)
...
* The following workspace dependencies were updated
  * dependencies
    * helia bumped from ^7.1.0 to ^7.1.1

## [11.0.8](https://github.com/ipfs/helia/compare/interop-v11.0.7...interop-v11.0.8) (2026-07-10)


### Bug Fixes

* pin kubo interop node to unixfs-v1-2025 ([#1083](https://github.com/ipfs/helia/issues/1083)) ([2520fb9](https://github.com/ipfs/helia/commit/2520fb92559d2f02b10fe46090b37ff414cb80ef))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/car bumped from ^6.0.3 to ^6.0.4
    * @helia/dag-cbor bumped from ^6.0.3 to ^6.0.4
    * @helia/dag-json bumped from ^6.0.3 to ^6.0.4
    * @helia/delegated-routing-client bumped from ^1.0.4 to ^1.0.5
    * @helia/interface bumped from ^7.0.3 to ^7.1.0
    * @helia/ipns bumped from ^10.0.4 to ^10.0.5
    * @helia/json bumped from ^6.0.3 to ^6.0.4
    * @helia/libp2p bumped from ^1.0.5 to ^1.0.6
    * @helia/mfs bumped from ^8.0.3 to ^8.0.4
    * @helia/strings bumped from ^6.0.3 to ^6.0.4
    * @helia/unixfs bumped from ^8.0.3 to ^8.0.4
    * helia bumped from ^7.0.5 to ^7.1.0

## [11.0.7](https://github.com/ipfs/helia/compare/interop-v11.0.6...interop-v11.0.7) (2026-07-04)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/car bumped from ^6.0.2 to ^6.0.3
    * @helia/dag-cbor bumped from ^6.0.2 to ^6.0.3
    * @helia/dag-json bumped from ^6.0.2 to ^6.0.3
    * @helia/delegated-routing-client bumped from ^1.0.3 to ^1.0.4
    * @helia/interface bumped from ^7.0.2 to ^7.0.3
    * @helia/ipns bumped from ^10.0.3 to ^10.0.4
    * @helia/json bumped from ^6.0.2 to ^6.0.3
    * @helia/libp2p bumped from ^1.0.4 to ^1.0.5
    * @helia/mfs bumped from ^8.0.2 to ^8.0.3
    * @helia/strings bumped from ^6.0.2 to ^6.0.3
    * @helia/unixfs bumped from ^8.0.2 to ^8.0.3
    * helia bumped from ^7.0.4 to ^7.0.5
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * helia bumped from ^7.0.2 to ^7.0.3
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/car bumped from ^5.4.2 to ^6.0.0
    * @helia/dag-cbor bumped from ^5.1.1 to ^6.0.0
    * @helia/dag-json bumped from ^5.1.1 to ^6.0.0
    * @helia/delegated-routing-client bumped from ^0.0.0 to ^1.0.0
    * @helia/dnslink bumped from ^1.2.1 to ^2.0.0
    * @helia/interface bumped from ^6.2.1 to ^7.0.0
    * @helia/ipns bumped from ^9.2.1 to ^10.0.0
    * @helia/json bumped from ^5.1.1 to ^6.0.0
    * @helia/libp2p bumped from ^0.0.0 to ^1.0.0
    * @helia/mfs bumped from ^7.1.1 to ^8.0.0
    * @helia/strings bumped from ^5.1.1 to ^6.0.0
    * @helia/unixfs bumped from ^7.2.1 to ^8.0.0
    * helia bumped from ^6.1.4 to ^7.0.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/car bumped from ^5.4.1 to ^5.4.2
    * @helia/http bumped from ^3.1.3 to ^3.1.4
    * helia bumped from ^6.1.3 to ^6.1.4

## [10.2.4](https://github.com/ipfs/helia/compare/interop-v10.2.3...interop-v10.2.4) (2026-04-13)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @helia/http bumped from ^3.1.2 to ^3.1.3
    * helia bumped from ^6.1.2 to ^6.1.3
...
* The following workspace dependencies were updated
  * dependencies
    * @helia/block-brokers bumped from ^5.1.3 to ^5.1.4
    * @helia/car bumped from ^5.3.9 to ^5.3.10
    * @helia/http bumped from ^3.0.21 to ^3.0.22
    * @helia/mfs bumped from ^7.0.4 to ^7.0.5
    * @helia/unixfs bumped from ^7.0.4 to ^7.1.0
    * helia bumped from ^6.0.21 to ^6.0.22
