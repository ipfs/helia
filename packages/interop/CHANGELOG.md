...
## [2.0.0](https://www.github.com/ipfs/helia/compare/interop-v1.0.0...interop-v2.0.0) (2023-08-16)
...
* The following workspace dependencies were updated
  * devDependencies
    * @helia/interface bumped from ^2.0.0 to ^3.0.0
    * helia bumped from ^2.0.0 to ^3.0.0
