...
# @helia/dag-json-interop <!-- omit in toc -->
...
> Interop tests for @helia/dag-json

## Table of contents <!-- omit in toc -->

- - [Install](#install)
    - [Browser `<script>` tag](#browser-script-tag)
- [@helia/dag-json-interop <!-- omit in toc -->](#heliadag-json-interop----omit-in-toc---)
  - [API Docs](#api-docs)
  - [License](#license)
...
```console
$ npm i @helia/dag-json-interop
```

### Browser `<script>` tag

Loading this module through a script tag will make it's exports available as `HeliaDagJsonInterop` in the global namespace.

```html
<script src="https://unpkg.com/@helia/dag-json-interop/dist/index.min.js"></script>
```

## API Docs

- <https://ipfs.github.io/helia-dag-json/modules/_helia_dag_json_interop.html>
